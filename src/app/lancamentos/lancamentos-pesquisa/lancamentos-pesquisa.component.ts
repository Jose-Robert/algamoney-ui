...
export class LancamentosPesquisaComponent {
  ...
  lancamentos = [
    ...
    { tipo: 'RECEITA', descricao: 'Venda de carro', dataVencimento: new Date(2020, 8, 10),
      dataPagamento: null, valor: 55000, pessoa: 'Sebastião Souza' },
    { tipo: 'DESPESA', descricao: 'Aluguel', dataVencimento: new Date(2020, 6, 15),
      dataPagamento: new Date(2019, 5, 22), valor: 1750, pessoa: 'Casa Nova Imóveis' },
    { tipo: 'DESPESA', descricao: 'Mensalidade musculação', dataVencimento: new Date(2011, 11, 19),
